  ...
  return(
    ...
    <Transition.Root show={isOpen} as={Fragment} >
      <Dialog as="div" className="relative z-50" onClose={onClose} >
        ...
        >
          <div className="aboslute inset-0 overflow-hidden">
            <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
              <Transition.Child
              as={Fragment}
              enter="transform transition ease-in-out durantion-500"
              enterFrom="translate-x-full"
              enterTo="translate-x-0"
              leave="transform transition ease-in-out durantion-500"
              leaveTo="translate-x-full"
              >
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-scroll-y bg-white py-6 shadow-xl">
                        ...
                        <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0">
                          ...
                          {!data.isGroup && (
                            ...
                            <div>
                              ...
                              <dd
                              className="mt-1 text-sm text-gray-900 ms:col-span-2"
                              >
